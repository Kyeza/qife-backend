# Generated by Django 3.1.1 on 2020-09-14 03:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(blank=True, choices=[('FARMER', 'Farmer'), ('EQUIP_OWNER', 'Equipment Owner')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            bases=('users.user',),
            managers=[
                ('objects', users.models.EquipmentOwnerManager()),
            ],
        ),
        migrations.CreateModel(
            name='Farmer',
